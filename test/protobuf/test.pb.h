...
// int32 errcode = 1;
inline void GetFriendListsResponse::clear_errcode() {
  errcode_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 GetFriendListsResponse::_internal_errcode() const {
  return errcode_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 GetFriendListsResponse::errcode() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponse.errcode)
  return _internal_errcode();
}
inline void GetFriendListsResponse::_internal_set_errcode(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  errcode_ = value;
}
inline void GetFriendListsResponse::set_errcode(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_errcode(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListsResponse.errcode)
}

// string errmsg = 2;
inline void GetFriendListsResponse::clear_errmsg() {
  errmsg_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& GetFriendListsResponse::errmsg() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponse.errmsg)
  return _internal_errmsg();
}
inline void GetFriendListsResponse::set_errmsg(const std::string& value) {
  _internal_set_errmsg(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListsResponse.errmsg)
}
inline std::string* GetFriendListsResponse::mutable_errmsg() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResponse.errmsg)
  return _internal_mutable_errmsg();
}
inline const std::string& GetFriendListsResponse::_internal_errmsg() const {
  return errmsg_.GetNoArena();
}
inline void GetFriendListsResponse::_internal_set_errmsg(const std::string& value) {
  
  errmsg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void GetFriendListsResponse::set_errmsg(std::string&& value) {
  
  errmsg_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.GetFriendListsResponse.errmsg)
}
inline void GetFriendListsResponse::set_errmsg(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  errmsg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.GetFriendListsResponse.errmsg)
}
inline void GetFriendListsResponse::set_errmsg(const char* value, size_t size) {
  
  errmsg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.GetFriendListsResponse.errmsg)
}
inline std::string* GetFriendListsResponse::_internal_mutable_errmsg() {
  
  return errmsg_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* GetFriendListsResponse::release_errmsg() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListsResponse.errmsg)
  
  return errmsg_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void GetFriendListsResponse::set_allocated_errmsg(std::string* errmsg) {
  if (errmsg != nullptr) {
  ...
  errmsg_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), errmsg);
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListsResponse.errmsg)
}

// repeated .fixbug.user users = 3;
inline int GetFriendListsResponse::_internal_users_size() const {
  return users_.size();
}
inline int GetFriendListsResponse::users_size() const {
  return _internal_users_size();
}
inline void GetFriendListsResponse::clear_users() {
  users_.Clear();
}
inline ::fixbug::user* GetFriendListsResponse::mutable_users(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResponse.users)
  return users_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::user >*
GetFriendListsResponse::mutable_users() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListsResponse.users)
  return &users_;
}
inline const ::fixbug::user& GetFriendListsResponse::_internal_users(int index) const {
  return users_.Get(index);
}
inline const ::fixbug::user& GetFriendListsResponse::users(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponse.users)
  return _internal_users(index);
}
inline ::fixbug::user* GetFriendListsResponse::_internal_add_users() {
  return users_.Add();
}
inline ::fixbug::user* GetFriendListsResponse::add_users() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsResponse.users)
  return _internal_add_users();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::user >&
GetFriendListsResponse::users() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListsResponse.users)
  return users_;
}
