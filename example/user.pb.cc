...
const char descriptor_table_protodef_user_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\025.fixbug.LoginResponse\022;\n\006Resist\022\027.fixbu"
  "g.RegisterRequest\032\030.fixbug.RegisterRespo"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_user_2eproto = {
  &descriptor_table_user_2eproto_initialized, descriptor_table_protodef_user_2eproto, "user.proto", 456,
...
void UserServiceRpc::Resist(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::fixbug::RegisterRequest*,
                         ::fixbug::RegisterResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method Resist() not implemented.");
  done->Run();
}
...
void UserServiceRpc_Stub::Resist(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
